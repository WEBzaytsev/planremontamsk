...
function planremonta()
{
    ...
    wp_enqueue_style('response_1217', get_template_directory_uri() . '/css/response_1217.css', array(), '1.0.0', '(max-width: 1217px)');
...
if( function_exists('acf_add_local_field_group') ):
  ...
  acf_add_local_field_group(array(
    'key' => 'group_61e91207ce61d',
    'title' => 'Главная',
    'fields' => array(
      array(
        'key' => 'field_61e90de621c92',
        'label' => 'Главный экран',
        'name' => '',
        'type' => 'tab',
        'instructions' => '',
        ...
        'sub_fields' => array(
          ...
          array(
            ...
            'sub_fields' => array(
              ...
              array(
                'key' => 'field_61e9104d21cb0',
                'label' => 'Включенные работы',
                'name' => 'vklyuchennye_raboty',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
      ...
      array(
        'key' => 'field_61f01c7aca755',
        'label' => 'Просмотр объекта Форма',
        'name' => '',
        'type' => 'tab',
        'instructions' => '',
        'required' => 0,
  ...
  acf_add_local_field_group(array(
    'key' => 'group_61e930c50c129',
    'title' => 'Опции',
    'fields' => array(
      array(
        'key' => 'field_61e930c7bdaa1',
        'label' => 'Телефон',
        'name' => 'phone',
        'type' => 'text',
        'instructions' => '',
